...
# Convierte el informe en un formato Markdown
try:
...
# Crea o agrega los resultados al README.md
with open('README.md', 'a', encoding='utf-8') as f:  # Modo 'a' para agregar
    f.write("\n## Resultados del modelo SVM\n")
    f.write("Informe de clasificación con kernel 'rbf':\n\n")
    f.write(markdown_table + "\n")

print("Resultados del modelo SVM agregados al README.md")
